...
class PrioritizationTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.source = json.loads((ROOT / "fixtures/canvas_contract_1_4.input.json").read_text(encoding="utf-8"))
...
class PrioritizationRouteTests(unittest.TestCase):
    def setUp(self):
        ...
        source = json.loads((ROOT / "fixtures/canvas_contract_1_4.expected.json").read_text(encoding="utf-8"))
