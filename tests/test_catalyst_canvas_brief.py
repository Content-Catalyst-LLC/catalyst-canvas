...
from catalyst_canvas_brief import CanvasInput, build_canvas_brief, export_payload


class CatalystCanvasBriefTests(unittest.TestCase):
    ...
    def test_export_payload_includes_inputs_and_canvas(self):
