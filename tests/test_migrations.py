...
class CanvasMigrationTests(unittest.TestCase):
    ...
    def test_future_contract_is_rejected_with_supported_version(self):
        with self.assertRaisesRegex(UnsupportedContractVersion, "catalyst-canvas/1.4"):
...
class ContractOneMigrationTests(unittest.TestCase):
    def test_contract_1_0_migrates_to_contract_1_4(self):
        ...
        self.assertIn("research, ideation, and prioritization fields", result.warnings[0])
