"""Command-line interface for Canvas Contract 2.0."""
...
def command_validate(args: argparse.Namespace) -> int:
    ...
    print(f"PASS: {args.input} is a valid Canvas Contract 2.0 payload.")
    return 0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    generate = subparsers.add_parser("generate", help="Generate Canvas Contract 2.0 from compact JSON input.")
    ...
    validate = subparsers.add_parser("validate", help="Validate a Canvas Contract 2.0 JSON document.")
