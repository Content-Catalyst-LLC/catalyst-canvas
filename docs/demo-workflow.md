...
The Flask workspace persists projects and immutable revisions in SQLite. The WordPress shortcode uses browser-local storage. Both surfaces emit Canvas Contract 2.0 and preserve the same canonical fixture.
