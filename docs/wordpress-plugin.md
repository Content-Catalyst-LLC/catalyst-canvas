...
The v1.9.0 shortcode plugin uses four dependency-free scripts:

1. generated release and registry data;
2. the shared browser Canvas Contract 1.6 engine;
