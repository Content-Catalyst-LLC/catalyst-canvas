...
Persona, stakeholder, and journey evidence links resolve against the Contract 1.6 ledger. Saving a revision indexes both design-research records and source/evidence/claim/assumption records in the active workspace. Reuse creates a new immutable revision and does not mutate the contributing project.
