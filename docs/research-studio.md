...
The v1.5.0 research studio is the structured design-research layer inside each Catalyst Canvas workspace. It is designed to keep research findings, observations, and assumptions distinguishable throughout framing, journey design, and experimentation.
...
Persona, stakeholder, and journey evidence links resolve against the Contract 1.2 ledger. Saving a revision indexes both design-research records and source/evidence/claim/assumption records in the active workspace. Reuse creates a new immutable revision and does not mutate the contributing project.
