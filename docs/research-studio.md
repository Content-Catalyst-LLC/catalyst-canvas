...
The v1.4.0 research studio is the structured design-research layer inside each Catalyst Canvas workspace. It is designed to keep research findings, observations, and assumptions distinguishable throughout framing, journey design, and experimentation.
