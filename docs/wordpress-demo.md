...
1. Upload and activate `catalyst-canvas-demo-v1.3.0.zip`.
...
The demo does not transmit visitor inputs. Version 1.3.0 saves projects and revisions only in the current browser localStorage.
