...
- `contract.py` normalizes and validates Canvas Contract 2.0.
...
- `migrations.py` upgrades recognized Contracts 1.0 through 1.6 and legacy payloads.

The WordPress engine is implemented in JavaScript because it runs locally in the visitor's browser. Its generated registry and exact Contract 2.0 fixture are compared with Python and Flask in Node conformance tests.
