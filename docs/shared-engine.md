...
- `contract.py` normalizes and validates Canvas Contract 1.6.
...
- `migrations.py` upgrades recognized Contracts 1.0 through 1.5 and legacy payloads.

The WordPress engine is implemented in JavaScript because it runs locally in the visitor's browser. Its generated registry and exact Contract 1.6 fixture are compared with Python and Flask in Node conformance tests.
