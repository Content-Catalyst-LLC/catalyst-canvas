...
Contract: catalyst-canvas/1.6  
Canvas ID: canvas-fixture-001  
Revision ID: revision-fixture-collaboration-001  
Status: active  
Updated: 2026-07-16T23:30:00+00:00  
...
Experiment readiness: learning_recorded · Experiments: 1 · Completed runs: 1  
Collaboration readiness: ready_for_publication · Open comments: 1 · Pending reviews: 0 · Published releases: 0
...
Frame the progress a person is trying to make in a specific situation.
...
**Intended uses:** Opportunity framing, Persona refinement, Service concept generation  
**Limitations:** Can underrepresent institutional and collective dynamics, Requires validation with real users
...
- prototype-001 — Neighborhood heat-action brief v0.2 [paper/medium/iterating] — owner: Program Design Team; success: Partners independently identify the intended action, evidence limitation, and accountable owner.; limitations: The prototype does not validate the underlying heat indicators.

## Hypotheses

- hypothesis-001 [usability/partially_supported/medium] — A one-page evidence-gap action card enables municipal and neighborhood partners to identify the same next action and material evidence limitation. — falsification: Fewer than four of five reviewers identify both the intended action and the evidence limitation without facilitator interpretation.

## Experiment Plans

- experiment-001 — Cross-agency clarity experiment [complete] — objective: Determine whether the brief supports a shared pilot interpretation without hiding evidence gaps.; method: Run a 30-minute task-based review with municipal and neighborhood partners, followed by independent recall and a facilitated debrief.; participants: 5; metrics: Shared next-action identification, Evidence-gap visibility; blockers: none

Experiment readiness is a workflow coverage indicator. It does not establish safety, causal validity, statistical power, desirability, feasibility, or impact.

## Experiment Runs and Results

- experiment-run-001 — experiment-001 [complete/partially_supported] — participants: 5; Four participants identified the intended next action, but only three independently named the primary evidence limitation.

## Learning Decisions

- learning-decision-001 [iterate] — The action structure is usable, but evidence limitations need stronger placement and wording before a larger pilot.; next: Move the confidence statement beside the proposed action; Retest the revised brief with at least five additional reviewers

## Prototype Iteration History

- iteration-001 — prototype-001 0.1 → 0.2: Moved the confidence statement next to the action and simplified the evidence-gap language. — The first run showed that two participants overlooked the evidence limitation.

## Experiment Handoffs

- research_lab [ready] — Run a larger controlled clarity study and preserve de-identified result data.; experiments: experiment-001
- workbench [draft] — Validate metric definitions and prepare a reusable experiment scorecard.; experiments: experiment-001

## Legacy Prototype Summary

**Neighborhood heat-action brief** — A printable brief linking one neighborhood risk signal to one operational response, one confidence statement, and one review checkpoint.
...
- Tariq Ahmad (member-owner) — owner [active]
- Editorial lead (member-editor) — editor [active]
- Independent reviewer (member-reviewer) — reviewer [active]

## Review Assignments

- review-assignment-001 — Public evidence and accessibility review [complete] — reviewer: member-reviewer; due: 2026-07-18T17:00:00-05:00; sections: publication-001

## Collaboration Comments

- comment-001 [resolved/reviewers] — Keep the confidence qualifier in the public brief. — author: member-reviewer; section: claims[0]
- comment-002 [open/internal] — Add the source revision to the release note. — author: member-editor; section: publication.release_notes

## Publication Approvals

- approval-001 [approved] — approver: member-reviewer; scope: Publication public-safe package; rationale: Required review is complete and unsupported claims remain visibly qualified.

## Publication Records

- publication-001 — Community Heat Resilience: Reviewable Action Brief [approved/wordpress] — type: public_brief; reviews: review-assignment-001; approvals: approval-001; redactions: Participant recruitment details, internal comments, member records, and private observation notes are excluded.

Collaboration readiness describes recorded assignments, comments, approvals, redaction notes, and publication state. It does not establish legal clearance, factual accuracy, accessibility, security, ethical acceptability, or institutional authorization.
...
- wordpress [ready] — publication: publication-001; purpose: Publish the reviewed public-safe brief.

## Provenance

Generated by Catalyst Canvas 1.9.0 from the fixture surface.
